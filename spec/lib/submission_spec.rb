describe Theoj::Submission do
  ...
  it "generates a plain text version of the title" do
    ...
    markup_title = "test\\_lib: A <code>mesh generator</code> for automatic, efficient, and robust mesh&nbsp;generation for <span>large-scale</span> cosmological modeling and simulation"
